...
void GcodeSuite::process_parsed_command(const bool no_ok /*=false*/) {
    ...
    case 'M':
        ...
        case 7:
            M7();
            break; // M7: Coolant Mist ON
#endif

#if EITHER(AIR_ASSIST, COOLANT_FLOOD)
        case 8:
            M8();
            break; // M8: Air Assist / Coolant Flood ON
#endif

#if EITHER(AIR_ASSIST, COOLANT_CONTROL)
        case 9:
            M9();
            break; // M9: Air Assist / Coolant OFF
#endif
        ...
        case 73:
            M73();
            break; // M73: Set progress percentage
#endif
        ...
        case 102:
            M102();
            break; // M102: Configure Bed Distance Sensor
#endif
        ...
        case 123:
            M123();
            break; // M123: Report fan states or set fans auto-report interval
#endif
    ...
    // PWM for HEATER_2_PIN
        ...
        case 255:
            M255();
            break; // M255: Set LCD Sleep/Backlight Timeout (Minutes)
#endif

#if HAS_LCD_BRIGHTNESS
        case 256:
            M256();
            break; // M256: Set LCD brightness
#endif
        ...
        case 423:
            M423();
            break; // M423: Reset, modify, or report X-Twist Compensation data
#endif
        ...
        case 665:
            M665();
            break; // M665: Set Kinematics parameters
#endif
        ...
        case 919:
            M919();
            break; // M919: Set stepper Chopper Times
#endif
