...
const uint8_t O_READ = 0x01,        // open() oflag for reading
...
protected:
    ...
    static const uint8_t F_OFLAG = (O_ACCMODE | O_APPEND | O_SYNC), // should be 0x0F
    ...
    bool mkdir(SdBaseFile* parent, const uint8_t dname[11] OPTARG(LONG_FILENAME_WRITE_SUPPORT, const uint8_t dlname[LONG_FILENAME_LENGTH]));
    bool open(SdBaseFile* dirFile, const uint8_t dname[11] OPTARG(LONG_FILENAME_WRITE_SUPPORT, const uint8_t dlname[LONG_FILENAME_LENGTH]), uint8_t oflag);
