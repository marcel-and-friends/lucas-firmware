...
#define FAST_PWM_FAN // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
    ...
    #define FAST_PWM_FAN_FREQUENCY 7180 // Define here to override the defaults below
...
#define HOMING_BUMP_MM \
    { 5, 5 } // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR \
    { 2, 2 } // Re-Bump Speed Divisor (Divides the Homing Feedrate)
